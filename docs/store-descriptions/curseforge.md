...
2. Download the file matching your Minecraft version and loader from the **Files** tab. Every Minecraft version in the table above is supported, and each download is labelled with its Minecraft version and loader.
